...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Flores amarillas para Amor" },
      { name: "description", content: "Una sorpresa hecha con amor para el 21 de septiembre." },
      { name: "author", content: "Con amor" },
      { property: "og:title", content: "Flores amarillas para Amor" },
